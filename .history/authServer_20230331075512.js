  ...
  : us.username === username && us.password === password */{
    if (data.email) {
      ...
      if (us.email.includes(data.email)) {
        ...
        foundUser = newUser; // gán giá trị cho biến user
      }
      
  }else{
    foundUser = (us.username === username && us.password === password)
  }});
