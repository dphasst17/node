...
const uri = `mongodb+srv://${process.env.USER_QL}:${process.env.PAS_QL}@databasetech.hulrvg5.mongodb.net/?retryWrites=true&w=majority`;
...
app.listen(PORT, () => {
  ...
  console.log(process.env.USER_QL)
});
