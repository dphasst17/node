...
import {getCount,addNew, addNewSecond, changeID, getDataLogin,insertData,updateRefresh} from "./db.js";
...
/* changeID().then(rs => {return id = rs}) */
let id = 0;
async function change(){
  await changeID();
  id = getCount() || result.length;
  console.log(id)
}
change().then(() =>{console.log(id)})
