...
mongoose.connect(`mongodb+srv://techstore:${process.env.PAS_QL}@tech.msftkp1.mongodb.net/User?retryWrites=true&w=majority`,{
  useNewUrlParser:true,
  useUnifiedTopology:true,
});
const MyModel = mongoose.model('userInf', new mongoose.Schema({ username: String }));
MyModel.find({}).then(function(docs) {
  console.log(docs);
});
